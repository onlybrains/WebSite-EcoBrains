														...
														<tr>
															<td width='540' valign='top' align='center'>
																<table width='100%' cellspacing='0' cellpadding='0' role='presentation'>
																	...
																	<tr>
																		<td class='es-p15t'>
																			<p style='color: #07401b;text-align: justify'>Seu interesse pelo tópico de negociação <strong>'coop->titulo_topico'</strong> foi <strong style='color: #07401b;'>aceito</strong>!&nbsp;Seguem as informações da empresa responsável pelo tópico.<br/><br/>
																			<strong>Nome: </strong>{$coop->nomeFantasia_dados}<br/>
																			<strong>Telefone: </strong>{$coop->tel_dados}<br/>
																			<strong>Whatsapp: </strong>{$coop->whatsapp_dados}<br/>
																			<strong>Email: </strong>{$coop->email_login}<br/>
																			<strong>CEP: </strong> <a target='_blank' href='https://www.google.com/maps/dir//{$coop->cep_dados}'>Clique aqui e veja a localização da empresa</a><br/>
																			<strong>CNPJ: </strong>{$coop->cnpj_dados}<br/>
