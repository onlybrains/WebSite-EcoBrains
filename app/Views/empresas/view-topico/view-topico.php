<div class="container">
  ...
  <div class="row mt-5 justify-content-center">
    ...
    <div class="col-md-6">
      <div class="d-flex justify-content-md-end justify-content-between">
        <a href="<?= base_url('/empresas/editartopico/' . $registroEmpresa->id_topico) ?>" class="topic-button btn p-2 mr-2 text-white">
          Editar Tópico
        </a>
        <a href="<?= base_url('/empresas/deletartopico/' . $registroEmpresa->id_topico) ?>" class="topic-button btn p-2 text-white">
          Excluir Tópico
        </a>
      </div>
    </div>
  ...
  <div class="row my-4 justify-content-center">
    <div class="rounded-lg sign-up col-11 bg-light">
      <form>
        <div class="form-row">
        ...
        <div class="card-coop border">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-4 d-flex flex-wrap align-items-center justify-content-around">
                <a href=<?= base_url('empresas/coop/' . $registro->id_coop) ?> class="topic-button btn p-2 my-2 mr-2 text-white">
                  Conheça a Cooperativa
                </a>
                <a href="<?= base_url('empresas/aprovar/' . $registro->id_topico . '/' . $registro->id_coop); ?>" class="topic-button p-2 my-2 mr-2 text-white">
                ...
                <a href="<?= base_url('empresas/negar/' . $registro->id_topico . '/' . $registro->id_coop); ?>" class="topic-button p-2 my-2 text-white">
