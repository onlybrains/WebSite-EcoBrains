<div class="container">
  ...
  <div class="row mt-5">
    ...
    <div class="col-md-3">
      <div class="row">
        <a href="<?= base_url('/empresas/editartopico/' . $registroEmpresa->id_topico) ?>"
          class="topic-button p-2 mt-2 mr-2 text-white">
          Editar Tópico
        </a>
        <a href="<?= base_url('/empresas/deletartopico/' . $registroEmpresa->id_topico) ?>"
          class="topic-button p-2 mt-2 mr-4 text-white">
          Excluir Tópico</a>
      </div>
    </div>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4 border-bottom m-0 p-2">
            ...
            <input class="form-control" type="text" readonly
              value="<?php echo date('d/m/Y', strtotime(($registroEmpresa->dataLimite_topico))); ?>">
      </form>
    </div>
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="row">
                ...
                <a href="<?= base_url('empresas/aprovar/' . $registro->id_topico . '/' . $registro->id_coop); ?>"
                  class="topic-button p-2 mt-4 mr-4 text-white"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16"
                    class="bi bi-check2" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                      d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z" />
                  </svg></a>
                <a href="<?= base_url('empresas/negar/' . $registro->id_topico . '/' . $registro->id_coop); ?>"
                  class="topic-button p-2 mt-4 mr-4 text-white"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16"
