      ...
      <div class="card-coop">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-2">
              <div class="row">
                <a href="<?= base_url('empresas/topicos')?>" class="topic-button p-2 mt-4 mr-4 text-white">
                ...
                <a href="<?= base_url('empresas/editartopico/')?>" class="topic-button p-2 mt-4 mr-4 text-white"><svg width="37" height="27" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
