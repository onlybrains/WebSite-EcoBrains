<div class="container-fluid">
  ...
  <div class="row my-2">
    ...
    <div class="col-md-2">
      <a href="<?= base_url('empresas/abrirtopico') ?>" class="topic-button p-1 mt-4 float-right mr-5 text-white"><svg
          width="40" height="30" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor"
      ...
      <div class="card-coop">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-2">
              <div class="row">
                <a href="<?= base_url('/empresas/topicos/' . $topico->id_topico); ?>"
                  class="topic-button p-2 mt-4 mr-4 text-white">
                  <svg width="37" height="27" viewBox="0 0 16 16" class="bi bi-list-ul" fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                      d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm-3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2z" />
                  </svg>
                </a>
                <a href="<?= base_url('empresas/editartopico/' . $topico->id_topico); ?>"
                  class="topic-button p-2 mt-4 mr-4 text-white"><svg width="37" height="27" viewBox="0 0 16 16"
