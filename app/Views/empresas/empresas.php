<div class="container-fluid pt-5">
  ...
  <div class="row my-2">
    ...
    <div class="col-md-2">
      <a href="#" class="topic-button p-1 mt-4 float-right mr-5 text-white"><svg width="40" height="30" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="row">
            ...
            <div class="col-md-2">
              <div class="row">
                ...
                <a href="#" class="topic-button p-2 mt-4 mr-4 text-white"><svg width="37" height="27" viewBox="0 0 16 16" class="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
