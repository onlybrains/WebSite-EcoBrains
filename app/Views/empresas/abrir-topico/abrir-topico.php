    ...
    <div class="col-8 bg-light p-0 rounded-lg sign-up">
      <form method="post">
        <div class="form-group border-bottom p-2 pl-4 pr-4 m-0">
          ...
          <input type="text" class="form-control border-0" name="titulo_topico" id="titulo_topico" placeholder="Tópico de Negociação 1" value="<?= set_value('titulo_topico') ?>">
        </div>
        <div class="form-group border-bottom p-2 pl-4 pr-4 m-0">
        ...
        <div class="form-group border-bottom p-2 pl-4 pr-4 m-0">
          ...
          <input type="text" class="form-control border-0" name="quant_residuo" id="quant_residuo" placeholder="25Kg" value="<?= set_value('quant_residuo') ?>">
        </div>
        <div class="form-group p-2 pl-4 pr-4 m-0">
          <label for="dataLimite_topico">Data Limite</label>
          <input type="date" class="form-control border-0" name="dataLimite_topico" id="dataLimite_topico" value="<?= set_value('dataLimite_topico') ?>">
        </div>
        <div class="d-flex">
