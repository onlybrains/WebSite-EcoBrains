<div class="container-fluid pt-5">
  <div class="row my-2">
    ...
    <div class="col-lg-12 col-md-12">
      <p class="subtitles-coop ml-5 mr-3 mt-3 pt-2">Pesquisar Tópicos de Negociação:</p>
    </div>
  </div>
</div>
<div class="row my-2">
  <div class="row ml-3">
    <p class="topic-desc">Data Limite: DD/MM/YYYY </p>
    <p class="topic-desc">Data Limite: DD/MM/YYYY </p>
    <p class="topic-desc">Data Limite: DD/MM/YYYY </p>
  </div>
</div>
...
<div class="row my-2">
  <div class="col-lg-12 col-md-12">
    <p class="subtitles-coop ml-5 mr-3 mt-3 pt-2">Tópicos que achamos que combina com você:</p>
  </div>
</div>
