      ...
      <form method="POST">
        <div class="form-row">
          <div class="form-group col-md-6 border-right border-bottom p-2 pl-5 m-0">
            ...
            <input type="email" class="form-control border-0 bg-transparent" name="inputEmail" id="inputEmail" placeholder="exemplo@exemplo.com.br">
          </div>
          <div class="form-group col-md-6 border-bottom p-2 pl-5 m-0">
            <label for="inputUser"><b>Usuário</b></label>
            <input type="text" class="form-control border-0 bg-transparent" name="inputUser" id="inputUser" placeholder="usuario_exemplo">
          </div>
        </div>
        <div class="form-group border-bottom p-2 pl-5 m-0">
          <label for="inputPassword"><b>Senha</b></label>
          <input type="password" class="form-control border-0 bg-transparent" name="inputPassword" id="inputPassword" placeholder="●●●●●●●●●●●●●●●●">
        </div>
        <div class="form-group p-2 pl-5 m-0">
          <label for="inputPassword2"><b>Confirmar Senha</b></label>
          <input type="password" class="form-control border-0 bg-transparent" name="inputPassword2" id="inputPassword2" placeholder="●●●●●●●●●●●●●●●●">
        </div>
        <div class="d-flex">
