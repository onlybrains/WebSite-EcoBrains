      ...
      <div class="card card-coop">
        <div class="card-body">
          <div class="container">
              ...
              <a href="<?= base_url('/CoopController/interesseTopico/'.$empresa->id_empresa);?>" class="btn-eco efeito p-3 float-right" style="margin-top: 90px;">Contato</a>
              <!--<a href="https://www.google.com/maps/dir//<?=$empresa->cep_empresa?>" target="_blank" class="btn-eco efeito mr-4 p-4 float-right" style="margin-top: 66px;">Veja a localização da empresa</a>-->
          ...
          <div class="row ml-3">
            ...
            <p class="topic-desc ml-2"> <?=substr($empresa->cnpj_empresa,0,2).".".substr($empresa->cnpj_empresa,2,3).".".substr($empresa->cnpj_empresa,5,3)."/".substr($empresa->cnpj_empresa,8,4)."-".substr($empresa->cnpj_empresa,-2);?></p>
          </div>
          <div class="row ml-3">
            <strong class="topic-desc">Telefone: </strong>
            <p class="topic-desc ml-2"><?='(' . substr($empresa->tel_empresa, 0, 2) . ') ' . substr($empresa->tel_empresa, 2, 4) . '-' . substr($empresa->tel_empresa, 6)?></p>
          </div>
          <div class="row ml-3">
            <strong class="topic-desc">WhatsApp: </strong>
            <p class="topic-desc ml-2"><?='(' . substr($empresa->whatsapp_empresa, 0, 2) . ') ' . substr($empresa->whatsapp_empresa, 2, 1) . ' ' . substr($empresa->whatsapp_empresa, 3, 4) . '-' . substr($empresa->whatsapp_empresa, 7)?></p>
          </div>
          <div class="row ml-3">
            <a class="topic-maps mb-3" target="_blank" href="https://www.google.com/maps/dir//<?=$empresa->cep_empresa?>">Clique aqui e veja a localização da empresa</a>
          </div>
        </div>
      </div>
    </div>
